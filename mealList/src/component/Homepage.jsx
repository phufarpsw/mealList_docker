      ...
      <div className="container-box pt-10 px-24 space-y-4">
        ...
        <div id="content" className="w-full pt-8 flex flex-col justify-center">
          <div className="w-full py-10">
            <input className="w-full px-8 py-5 bg-transparent border focus:border-rose-500 transition-colors duration-500 transition-duration-1000 outline-none rounded-full" placeholder="Enter your search" type="text" />
          </div>
          <div className="py-6 grid grid-cols-3 gap-10">{list}</div>
        </div>
      </div>
    </div>
  );
